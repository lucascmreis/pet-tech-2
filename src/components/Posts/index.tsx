            ...
            <div className="py-16 lg:py-20">
                ...
                <div className="pt-8 lg:pt-12">
                    ...
                    <div className="border-b border-grey-lighter pt-10 pb-8">
                        ...
                        <a href="#"
                            className="block font-body text-lg font-semibold text-primary transition-colors hover:text-green dark:text-white dark:hover:text-secondary">Diam
                    ...
                    <div className="border-b border-grey-lighter pt-10 pb-8">
                        ...
                        <a href="#"
                            className="block font-body text-lg font-semibold text-primary transition-colors hover:text-green dark:text-white dark:hover:text-secondary">In
                    ...
                    <div className="border-b border-grey-lighter pt-10 pb-8">
                        <span
                            className="mb-4 inline-block rounded-full bg-green-light px-2 py-1 font-body text-sm text-green">category</span>
                        <a href="#"
                            className="block font-body text-lg font-semibold text-primary transition-colors hover:text-green dark:text-white dark:hover:text-secondary">Elit
                    ...
                    <div className="border-b border-grey-lighter pt-10 pb-8">
                        ...
                        <a href="#"
                            className="block font-body text-lg font-semibold text-primary transition-colors hover:text-green dark:text-white dark:hover:text-secondary">Ut
                    ...
                    <div className="border-b border-grey-lighter pt-10 pb-8">
                        <span
                            className="mb-4 inline-block rounded-full bg-blue-light px-2 py-1 font-body text-sm text-blue">category</span>
                        <a href="#"
                            className="block font-body text-lg font-semibold text-primary transition-colors hover:text-green dark:text-white dark:hover:text-secondary">Etiam
