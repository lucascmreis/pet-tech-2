...
function Home() {
  ...
  const [hospitalRepository] = useState<HospitalRepository>(
    () => new HospitalRepository(10)
  );
  ...
  useEffect(() => {
    async function first() {
      ...
      const total =
        (await hospitalRepository.getTotal()) / hospitalRepository.perPage;
    ...
    <div className="bg-white">
      ...
      <PageContainer>
        <div className="flex items-center pb-6">
          <h3 className="ml-3 font-body text-2xl font-semibold text-primary dark:text-primary">
            ...
            {errors.phone && (
              <ErrorMessage role="alert">
                {errors.phone?.message ||
                  "O telefone tem que ser no formato (99) 99999-9999"}
              </ErrorMessage>
            )}
