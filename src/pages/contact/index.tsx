            ...
            <div className="container mx-auto">
                ...
                <div className="py-16 lg:py-20">
                    ...
                    <div className="pr-2 pt-3 sm:pt-0">
                        <p className="font-body text-xl font-light  text-white dark:text-primary">
                    ...
                    <form className="pt-16">
                        <div className="flex flex-col sm:flex-row">
                            <div className="w-full sm:mr-3 sm:w-1/2">
                                <label
                                    className="block pb-3 font-body font-medium  text-white dark:text-primary"
                                >Seu nome</label>
                                <input
                                    type="text"
                                    id="name"
                                    placeholder="Como devo te chamar?"
                                    className="w-full border border-primary bg-grey-lightest px-5 py-4 font-body font-light  text-white placeholder-primary transition-colors focus:border-secondary focus:outline-none focus:ring-2 focus:ring-secondary dark:text-primary"
                                />
                            </div>
                        ...
                        <div className="w-full pt-6 sm:pt-10">
                            <label className="block pb-3 font-body font-medium  text-white dark:text-primary"
                            >Mensagem</label>
                            <textarea
                                id="message"
                                cols={30}
