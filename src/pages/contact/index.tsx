            ...
            <div className="container mx-auto">
                <div>
                    ...
                    <ul className="list-disc pl-10 flex flex-wrap gap-2">
                        ...
                        <li className="font-body text-lg font-light  text-primary p-4 min-w-[200px] text-center list-none border-green-dark bg-green-light dark:text-primary">
                            ...
                            <a href="https://www.linkedin.com/in/maanolfi" rel="noreferrer" target="_blank" className='flex items-center gap-2'>
                                <img src="linkedin.svg" alt="rodrigo github" height={30} width={30} />Marco
                            </a>
                        </li>
                        <li className="font-body text-lg font-light  text-primary p-4 min-w-[200px] text-center list-none border-green-dark bg-green-light dark:text-primary">
                            <span className="font-medium">Rodrigo Queiroz Yamagushi</span>
                            <a href="https://github.com/teddiur/" target="_blank" rel="noreferrer" className='flex items-center gap-2'>
                ...
                <div className="py-16 lg:py-20">
                    ...
                    <form className="pt-16">
                        ...
                        <button
                            className="mt-10 mb-12 block bg-secondary px-10 py-4 text-center font-body text-xl font-semibold text-primary transition-colors hover:bg-green sm:inline-block sm:text-left sm:text-2xl"
                        >
                            Mandar mensagem
                        </button>
                    </form>
