    ...
    return (
        <div className="bg-primary">
            ...
            <div className="container mx-auto">
                ...
                <h1
                        className="pb-8 pt-5 font-body text-4xl font-semibold text-primary dark:text-white md:text-5xl lg:text-6xl"
                    >
                        Equipe
                    </h1>                   
                ...
                <div className="py-16 lg:py-20">                 
                    <h1
                        className="font-body text-4xl font-semibold text-primary dark:text-white md:text-5xl lg:text-6xl"
                    >
                        Contato
                    </h1>
